package com.leadnews.common.aliyun.util;
...
public class ClientUploader {
    ...
    /**
     * 涓婁紶骞惰幏鍙栦笂浼犲悗鐨勫浘鐗囬摼鎺?     * @param filePath
     * @return
     */
    ...
    /**
     * 涓婁紶骞惰幏鍙栦笂浼犲悗鐨勫浘鐗囬摼鎺?     * @param bytes
     * @return
     */
    ...
    private UploadCredentials getCredentialsFromServer() throws Exception{
        ...
        uploadCredentialsRequest.setAcceptFormat(FormatType.JSON); // 鎸囧畾api杩斿洖鏍煎紡
        uploadCredentialsRequest.setMethod(com.aliyuncs.http.MethodType.POST); // 鎸囧畾璇锋眰鏂规硶
